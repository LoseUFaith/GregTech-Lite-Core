...
internal class SingularityAssemblyUnitUI<R : RecipeMap<*>>(recipeMap: R) : RecipeMapUI<R>(recipeMap, true, true, true, true, false)
{
                                     ...
                                     importFluids: FluidTankList, exportFluids: FluidTankList, yOffset: Int): ModularUI.Builder
    {
        val builder = ModularUI.builder(GuiTextures.BACKGROUND, 176, 176)
            .widget(RecipeProgressWidget(200, 79, 12, 72, 40, progressBarTexture1(), progressBarMoveType1(), recipeMap()))
            .widget(RecipeProgressWidget(200, 140, 15, 3, 12, progressBarTexture2(), progressBarMoveType2(), recipeMap()))
                                       ...
                                       isOutputs: Boolean, yOffset: Int)
    {
        ...
        val startOutputsX = startInputsX1 + 144
        if (!isOutputs)
        {
            // Item input slots.
            for (h in 0..3)
        ...
        else
        {
            ...
            for (h in 0..3)
            {
                addSlot(builder, startOutputsX, startInputsY1 + 18 * h, h, itemHandler, fluidHandler, false, true)
            }
        }
    }

    private fun progressBarTexture1(): TextureArea = GTLiteGuiTextures.PROGRESS_BAR_ANTI_GRAVITY_ASSEMBLING_1
